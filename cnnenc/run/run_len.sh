...
# changed maxlen ; max epochs restricted
...
python char2char/train_bi_char2char.py -learning_rate 0.0005 -batch_size 16 -patience 1 -max_epochs 21 -model_path $model_path -data_path $data -maxlen 250 -maxlen_trg 250    # changed to 250
...
python char2char/train_bi_char2char.py -learning_rate 0.0005 -batch_size 16 -patience 1 -max_epochs 16 -model_path $model_path -data_path $data -maxlen 400 -maxlen_trg 400 -re_load
...
python char2char/train_bi_char2char.py -learning_rate 0.0001 -batch_size 16 -patience 2 -max_epochs 16 -model_path $model_path -data_path $data -maxlen 400 -maxlen_trg 400 -re_load
...
python char2char/train_bi_char2char.py -learning_rate 0.0001 -batch_size 64 -patience 3 -max_epochs 16 -model_path $model_path -data_path $data -maxlen 500 -maxlen_trg 500 -re_load

# all
./preprocess/mypreprocess.sh "$data/$S$T/train/" train_ref.$S train_ref.$T 2> /dev/null

python char2char/train_bi_char2char.py -learning_rate 0.0001 -batch_size 64 -patience 3 -max_epochs 31 -model_path $model_path -data_path $data -maxlen 500 -maxlen_trg 500 -re_load
