...
if __name__ == '__main__':
    ...
    parser.add_argument('-translate', type=str, default="bn_hi", help="bn_hi / cs_en / fi_en / ru_en")
    parser.add_argument('-highway', type=int, default=4)
    parser.add_argument('-model_path', type=str, default="/home/development/palak/curriculum/cnnenc/models/bn_hi/")
    parser.add_argument('-data_path', type=str, default="/home/development/palak/curriculum/data/")
...
#     args.model_path = "/home/development/palak/curriculum/cnnenc/models/" # change accordingly
#     args.data_path = "/home/development/palak/curriculum/data/" # change accordingly
